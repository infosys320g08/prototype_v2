...
public class DataConnect : MonoBehaviour
{
    ...
    //string WebsiteURL = "https://mboy951.azurewebsites.net/tables/Chair?zumo-api-version=2.0.0";
    ...
    void Start()
    {
        ...
        //Chair[] Chairs = JsonReader.Deserialize<Chair[]>(jsonResponse);
        Chair[] Chairs = JsonConvert.DeserializeObject<Chair[]>(jsonResponse);
        ...
        foreach (Chair Chair in Chairs)
        {
            ...
            Debug.Log("This Chairs name is: " + Chair.SeatNumber);
            //----------------------
            ...
            //newObject.transform.Find("New Text").GetComponent<TextMesh>().text = Chair.SeatNumber;//"Hullo Again";
            i++;
